        ...
        case 'B1':
            exampleNetwork = {
                ...
                "arcs": {
                    ...
                    "a3": {
                        "id": "a3",
                        "positionId": "p1762518318394",
                        "weight": 1,
                        "isInhibitor": false
                    },
                    "a4": {
                        "id": "a4",
                        "positionId": "p1762518319408",
                        "weight": 1,
                        "isInhibitor": false
                    },
                    "a5": {
                    ...
                    "a6": {
                        "id": "a6",
                        "positionId": "p1762518320197",
                        "weight": 1,
                        "isInhibitor": false
                    },
                    "a7": {
                        "id": "a7",
                        "positionId": "p1762518341598",
                        "weight": 1,
                        "isInhibitor": false
                    },
                    "a8": {
        ...
        case 'B2':
            exampleNetwork = {
                ...
                "arcs": {
                    "a1": {
                        "id": "a1",
                        "positionId": "p1762518450745",
                        "weight": 1,
                        "isInhibitor": false
                    },
                    "a2": {
                        "id": "a2",
                        "positionId": "p1762518451391",
                        "weight": 1,
                        "isInhibitor": false
                    },
                    "a3": {
        ...
        case 'A1':
            exampleNetwork = {
                ...
                "arcs": {
                    "a1": {
                        "id": "a1",
                        "positionId": "p1762503014857",
                        "weight": 1,
                        "isInhibitor": false
                    },
                    "a2": {
                        "id": "a2",
                        "positionId": "p1762503040408",
                        "weight": 1,
                        "isInhibitor": false
                    },
                    "a3": {
                    ...
                    "a6": {
                        "id": "a6",
                        "positionId": "p1762503016775",
                        "weight": 1,
                        "isInhibitor": false
                    },
                    "a7": {
                        "id": "a7",
                        "positionId": "p1762503140128",
                        "weight": 1,
                        "isInhibitor": false
                    },
                    "a8": {
                    ...
                    "a21": {
                        "id": "a21",
                        "positionId": "p1762504052935",
                        "weight": 1,
                        "isInhibitor": false
                    },
                    "a22": {
                        "id": "a22",
                        "positionId": "p1762504054780",
                        "weight": 1,
                        "isInhibitor": false
                    }
                }
...
function setupPropertyListeners() {
    ...
    document.getElementById('position-name').addEventListener('input', () => {
        if (selectedElementType === 'position' && selectedElement) {
            const newName = document.getElementById('position-name').value.trim();
            network.positions[selectedElement.id].name = newName !== '' ? newName : `P${selectedElement.id}`;
            render();
        }
    });

    document.getElementById('transition-name').addEventListener('input', () => {
        if (selectedElementType === 'transition' && selectedElement) {
            const newName = document.getElementById('transition-name').value.trim();
            // Аналогично позиции: проверяем на пустоту
            network.transitions[selectedElement.id].name = newName !== '' ? newName : `T${selectedElement.id}`;
            render();
        }
    });
...
function handleMouseDown(e) {
    ...
    if (currentTool === 'arc') {
        ...
        if (currentTool === 'position') {
            const id = 'p' + Date.now();
            const nameInput = document.getElementById("position-name").value.trim();
            const name = nameInput !== '' ? nameInput : `P${Object.keys(network.positions).length + 1}`;
            ...
            document.getElementById("position-name").value = `P${Object.keys(network.positions).length + 1}`;
            render();
        } else if (currentTool === 'transition') {
            const id = 't' + Date.now();
            const nameInput = document.getElementById("transition-name").value.trim();
            const name = nameInput !== '' ? nameInput : `T${Object.keys(network.transitions).length + 1}`;
            ...
            document.getElementById("transition-name").value = `T${Object.keys(network.transitions).length + 1}`;
            render();
        } else {
            const element = findElementAtPosition(x, y);
            if (element) {
...
function stepSimulation() {
    ...
    if (enabledTransitions.length > 0) {
        ...
        const transition = enabledTransitions[randomIndex];
